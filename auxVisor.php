...
?>
			<table border="0" cellpadding="1" cellspacing="1" width="99%" style="margin: 5px;font-size: 10px;">
			    <tr>
				<td style="width: 75%;height: 15px;padding: 5px;border: 1px solid #CCC;background: #f0f0f0;text-align: left;font-weight: bold;">Nombre</td>
				<td style="width: 10%;height: 15px;padding: 5px;border: 1px solid #CCC;background: #f0f0f0;text-align: left;font-weight: bold;">Tama&ntilde;o</td>
				<td style="width: 14%;height: 15px;padding: 5px;border: 1px solid #CCC;background: #f0f0f0;text-align: left;font-weight: bold;">Tipo</td>
			    </tr>
<?
...
?>						
				...
				<td style="border-bottom:1px solid #CCC;">
					...
					<div id="<?=$idDivEditar;?>" class="estiloDivHerr">
					    <a href="#" onclick="renombrarDirectorio('<?=$contenidoDir[$i];?>','<?=$idInputEditar;?>','<?=$idEnlace;?>')" title="Renombrar Directorio"><img src="img/duplicate.png" border="0" /></a> | <a href="#" onclick="eliminaDirectorio('<?=$contenidoDir[$i];?>')" title="Eliminar directorio"><img src="img/icon_delete.gif" border="0" /></a></div><div style="float: left;margin: 3px;">
					    <a id="<?=$idEnlace;?>" class="estiloListadoDirectorios" href="#" onclick="abrirDirectorio('<?=$path."/".$contenidoDir[$i];?>')" title="Ver Contenido..."><input type="checkbox" /><img src="img/folder-closed.gif" border="0" /><?=$contenidoDir[$i];?></a>
...
?>						
				...
				<td style="border-bottom:1px solid #CCC;">
				    <div style="clear: both;margin-bottom: 5px;margin-top: 5px;">
					<div id="<?=$idDivEditar;?>" class="estiloDivHerr">
					    <a href="#" onclick="renombrarDirectorio('<?=$contenidoDir[$i];?>','<?=$idInputEditar;?>','<?=$idEnlace;?>')" title="Renombrar Directorio"><img src="img/duplicate.png" border="0" /></a> |
					    <a href="#" onclick="eliminarArchivo('<?=$contenidoDir[$i];?>')" title="Eliminar archivo"><img src="img/icon_delete.gif" border="0" /></a>
					</div>
					<div style="float: left;margin: 3px;">
					    <a id="<?=$idEnlace;?>" class="estiloListadoDirectorios" href="#" onclick="mostrarArchivo('<?=$path."/".$contenidoDir[$i];?>')" title="Ver Archivo..."><input type="checkbox" /><img src="img/file.gif" border="0" /><?=$contenidoDir[$i];?></a>
					    <input type="text" onkeyup="guardarNuevoNombreDir('<?=$contenidoDir[$i];?>','<?=$idInputEditar;?>','<?=$idEnlace;?>',event)" name="<?=$idInputEditar;?>" id="<?=$idInputEditar;?>" value="<?=$contenidoDir[$i];?>" style="font-size: 10px;width: 300px;display:none;">
					</div>
				    </div>
				</td>
